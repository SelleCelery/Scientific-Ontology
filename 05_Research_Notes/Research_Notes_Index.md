...
| [DSSI：観測・判断主権・責任返還](./Social_Boundary_Notes/DSSI_Observation_Judgment_Sovereignty_and_Responsibility_Return.ja.md) / [EN](./Social_Boundary_Notes/DSSI_Observation_Judgment_Sovereignty_and_Responsibility_Return.en.md) | 観測と判断を分離し、AIやインターフェイスが判断所有権を奪わず、責任を利用者へ返す条件を研究する。 | 各文書ヘッダを正本とする。 | v5.0に含むのは研究ノートと実装境界であり、DSSIアプリケーション本体ではない。 |
