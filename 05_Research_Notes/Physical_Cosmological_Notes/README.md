...
この小分類では、科学語彙を使用する場合、以下を明示する。

- 標準定義を尊重すること
- 存在境界論上の再解釈であること
- 物理証明ではないこと
- 経験科学の代替ではないこと
- AMP/ITS由来の強い命題は、Research Notes上の主張強度管理を通すこと

### English commensurated rendering

When using scientific vocabulary, this subdirectory must state that:

- standard definitions are respected;
- the usage is a Scientific Ontology reinterpretation;
- it is not physical proof;
- it is not a replacement for empirical science;
- strong AMP/ITS-derived claims are handled through Research Notes claim-strength control.
