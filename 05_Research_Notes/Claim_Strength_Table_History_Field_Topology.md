...
> Status: Public research-management table / 公開用研究管理表  
> Layer: 05_Research_Notes  
> Scope: claim strength, publication handling, verification stage, misreading risk, application risk  
> Language: Japanese authoritative text / English commensurated rendering  
> Authoritative source: Japanese text  
> Claim strength: Classification tool, not proof / 分類道具であり証明ではない  
> Commensuration status: Japanese authoritative sections and tables are followed by English commensurated renderings. Japanese tables are authoritative when any difference appears.
...
- P codes classify publication layer.
- E codes classify risk of misreading, criticism, or pseudo-scientific interpretation.
- U codes classify application and safety risk.
...
The Japanese table above is authoritative. The key handling rules are:
...
AI-related concepts belong mainly in `04_Applications` unless they become high-claim or speculative enough to require Research Notes. Public AI materials should preserve judgment possibility and boundary integrity, while implementation procedures and private safety categories remain outside the public layer.
...
Social, life, and safety-culture concepts may be public when they remain conceptual and do not expose operational procedures. Concrete applications to high-risk systems require additional abstraction or non-public handling.
...
Literary and creative materials may be used as structural readings or metaphorical retreats. They do not prove Scientific Ontology, and they must not be turned into diagnostic or empirical claims.
