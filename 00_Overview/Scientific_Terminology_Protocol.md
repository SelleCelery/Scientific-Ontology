...
> Status: Public terminology protocol  
> Layer: `00_Overview` / repository governance  
> Scope: scientific vocabulary, reinterpretation, analogy, claim strength, publication risk  
> Language: English / Japanese  
> Authoritative source: Japanese descriptions unless otherwise stated  
> Claim: terminology management, not scientific proof or replacement of standard scientific definitions
...
## 1. Definitions Are Boundary Tools / 定義は公開境界の道具である
...
### 2.1 Respect Standard Scientific Definitions / 標準科学の定義を尊重する
...
### 2.2 Mark Reinterpretation Explicitly / 読み替えは明示する
...
### 2.3 Define SO-Specific Usage / SO内部定義を明示する
...
### 2.4 Create New Terms When Existing Terms Mislead / 誤読を招く場合は新語を作る
...
### 2.5 State Boundary Conditions / 限定条件を提示する
...
### 2.6 Do Not Collapse Claim Domains / 主張領域を混同しない
...
### B. Application and Safety Risk / 応用・安全リスク
...
## 6. Relation to Term Collision Registry / 用語衝突管理表との関係
