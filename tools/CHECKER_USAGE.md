...
The Python script checks what can be checked mechanically: metadata headers, README structure, local links, forbidden public paths, stale README document lists, public-manifest consistency, terminology drift, caution-term boundary markers, and lightweight release metadata.
...
- Allowed-near context for legacy terms such as former names.
