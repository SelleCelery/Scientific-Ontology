...
第一読解：  
同期・照合・残差・残渣の概念地図として読む。

第二読解：  
中心球体を宇宙そのものではなく、観測された世界が切り出される構造として読む。

第三読解：  
上下方向を論理-深度軸、水平方向を、ある観測者にとって空間、時間、対象、外的世界性が現れる断面として読む。

第四読解：  
赤道を、別の世界切断が立ち上がるビッグバン境界として読む。

第五読解：  
金融と残渣を、同期されたシステムがなお自分の閉鎖の外側に未照合の負荷を残すことを示す応用パネルとして読む。
...
これは、文字通りの天体、惑星、宇宙空間、外部空間の容器ではない。

この球体は、観測、境界操作、履歴、感性、悟性、論理深度を通じて、世界が切り出される以前の構造を表している。

このモデルにおいて、「宇宙」として現れるものは、球体全体ではない。宇宙は、球体を水平に切った断面として現れる。

より正確には、ある観測者にとっての外的世界は、赤道に平行な水平面または水平帯として切り出される。

球体の上下方向は、論理-深度軸として読むべきである。

球体の水平方向は、ある観測者にとって空間、時間、対象、関係、外的世界性が現れる分布面として読むべきである。

したがって、このポスターは「宇宙が物理空間内の球である」と主張しているのではない。
...
赤道はビッグバン境界であり、そこから世界切断が立ち上がる未分化可能性の線または帯である。

ある観測半球に位置する観測者にとって、赤道とは、現在の世界切断が未分化の閾値へ到達する限界である。

赤道を越えることは、同じ空間内の別地点へ移動することではない。

それは、現在の世界切断の死線を越え、別の世界性の分布へ入ることである。

赤道の向こうには、別の世界があるかもしれない。すなわち、空間、時間、力、対象性、意味が、別の仕方で切り出される世界である。

この意味で、空間と時間は絶対的な容器として扱われない。

空間と時間は、ある水平世界断面の内部で現れる分布様式である。

観測者が赤道境界を越えて別の半球に入るならば、水平方向はもはや同じ空間-時間分布に対応しない可能性がある。そこでは別の力体系と別のエントロピー分布が作動しているかもしれない。

極点は、光と闇のような単純な道徳的対立ではない。

極とは、外部対象が喪失し、すべてが観測者の内部論理として概念化される圧縮点である。

極においては、観測されるべき外部対象は残っていない。すべてが観測者の内部論理へ折り込まれている。

そのため、極にいる観測者は、その観測場の内部において全知のように見える場合がある。
...
観測者は、上下方向と水平方向の両方に自由度を持つ。

水平方向において、観測者は空間、時間、対象、社会関係、言語ゲーム、外的世界性の分布に参加する。

上下方向において、観測者は論理-深度軸に沿って動く。そこでは、未解決問題、矛盾、残差、残渣、分岐、意味圧が保持され、または再構成される。

観測は、外部入力だけによって決まるのではない。

観測は、内部履歴によって形成された感性と悟性の組み合わせによって決まる。

感性は、何が信号、違和感、差異、残差として立ち上がるかを決める。

悟性は、立ち上がったものが、対象、関係、原因、責任、価値、意味としてどのように分類されるかを決める。

理性は、これらの観測をどのように閉じるかに関わる。

理性は、慣性に従い、観測を安定した解釈として固定することがある。

理性はまた、慣性を超え、感性と悟性の在り方そのものを更新することがある。

この意味で、理性は単に結論を出す能力ではない。理性は、履歴をどのように扱うかを統御する力でもある。

より正確には、理性は、観測者が残差をどのように閉じ、保持し、再び開き、または再構成するかを統御する。

理性もまた慣性である。

理性が閉じるのは、安定のためである。

閉じていないものを閉じたいという欲求は、外部秩序としての獣性である。

この欲求が閉鎖を強制するだけなら、それは偽閉鎖となる。
...
これは、読者の視点を切り替えるための概念装置である。

球体モデルの目的は、宇宙、認識、意味について最終解釈を一つに固定することではない。

目的は、観測された世界が、観測者の履歴、感性、悟性、理性、残差処理を通じて、より深い構造から切り出されていることを可視化することである。

したがって、読者は異なる層からこのポスターへ入ってよい。
...
これらの読解は、単一の解釈へ還元される必要はない。

ただし、以下の主張境界は保持されるべきである。

球体は物理空間そのものではない。  
観測された世界は、より深い構造から切り出された断面である。  
上下方向は論理-深度を示す。  
水平断面は、ある観測者にとっての世界分布を示す。  
赤道は、別の世界切断が立ち上がる可能性のある閾値を示す。

この意味で、このポスターは閉じた説明ではない。
...
同期とは、SOにおける operational correspondence、すなわち内部ヒューリスティックと外部構造が運用上安定して噛み合うことである。

照合とは、一致、不一致、残差、残渣が何を意味するかを読む操作である。
...
残差は、単なる誤差やノイズではない。まだ再照合可能な差分である。

残渣は、処理済み、清算済み、決算済み、解決済みとされたあとにも沈殿して残るものである。

論理-深度軸は、未解決問題、矛盾、分岐、残差、残渣、意味圧を保持し、再構成する方向を示す。
...
このポスターは、すべての世界が単一の普遍言語を共有しているとは仮定しない。

異なる共同体、パラダイム、履歴場は、それぞれ異なる照合規則によって運用される場合がある。

パラダイム・ブリッジは、差異を消すものではない。残差を保持したまま、照合可能な対応面を作るものである。
...
これらのモチーフは、直接的な物理宇宙論モデルとして読むべきではない。

それらは、場がどのように安定化され、力や規則がどのように分化し、安定化の過程でどのように残差が発生するかを問うための概念的類比である。
...
それは、高度に同期されたシステムが、自身の運用枠内では清算済み・決算済みのように見えながら、その枠外に残渣を残す構造を示している。

金融、会計、取引は、あるものを閉鎖済み、清算済み、流動化済み、決算済みのように見せることがある。

しかし、金融的または会計的な枠内で清算済みとされたものが、身体、制度、生態系、共同体、未来世代、未発見能力においては未処理のまま残る場合がある。

このパネルは、金融について完全な一般理論または普遍的説明を主張するものではない。

ここで示しているのは一つの判断導線である。平面的、経済的、取引的な問題に見えるものが、実際には残渣と論理-深度軸への注目を必要とする場合がある、という導線である。
...
これらのモチーフは、直接的な実証主張として読まれるべきではない。

中心モデルは、物理空間が文字通り球体であると主張しているわけではない。

応用パネルは、金融、社会、計算、制度についての完全な一般理論を主張しているわけではない。

特に、金融と残渣のパネルは、金融が残渣へ還元されるとか、すべての金融システムが同じ構造を持つと主張しているわけではない。

そこで示されているのは、問いである。

あるシステムが平面的な運用面では清算済み・決算済みに見えるとき、論理-深度軸において何が未解決のまま残っているのか。

このポスターは、複数の読解経路を保持しながら、いくつかの重大な誤読を防ぐことを目的としている。
